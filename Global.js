...
if (header) { header.insertAdjacentHTML('beforeend', "<a href={0} target='_blank' style='position:absolute;top:12px;left:12px'>Mojito 1.43.2</a>".format(chrome.extension.getURL('options.html'))); }