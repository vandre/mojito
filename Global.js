...
if (header && !hasOptionsLink) { header.insertAdjacentHTML('beforeend', "<a href={0} class='mojito-options' target='_blank' style='position:absolute;top:12px;left:12px'>Mojito 1.51</a>".format(chrome.extension.getURL('options.html'))); }